...
function subNavClass(isActive: boolean) {
  return [
    'flex-1 inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200',
    isActive
...
export function ConceptsSubNav() {
  return (
    <nav
      className="flex w-full gap-2 rounded-2xl border border-sand-200 bg-cream-50/80 p-1.5 shadow-soft"
